...
$.ajax({
    ...
    data: {
        key: 'SLOBZ-3PSKC-FV32Q-ACXGU-CV57Q-2RFGE',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(120.98181, 31.38475, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
